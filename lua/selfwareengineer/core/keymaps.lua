...
keymap.set(
	"n",
	"<leader>!",
	'i<!doctype html><CR><html lang="en"><CR><head><CR><meta charset="UTF-8" /><CR><meta name="viewport" content="width=device-width, initial-scale=2.0" /><CR><link rel="stylesheet" href="style.css" /><CR><script type="module" src="script.js" defer></script><CR><title>Document</title><CR></head><CR><body></body><CR></html><ESC>',
